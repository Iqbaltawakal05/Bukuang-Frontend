  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Kategori Transaksi</h2>
          <p className="text-slate-500 text-xs sm:text-sm">Kelola pengelompokan pemasukan dan pengeluaran Anda</p>
        </div>
        <button
